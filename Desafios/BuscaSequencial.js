...
// ● Se o valor constar no array, retorne um texto contendo o valor 
// e sua respectiva posição no array. Caso contrario retorne um texto dizendo que
...
if (encontrado !== undefined){
  let indice = elementos.indexOf(encontrado)
  print(`Achei ${encontrado} na posicao ${indice}`)
} else {
